          ...
          <div class="card card-span mb-3 shadow-lg">
            <div class="card-body py-0">
              <div class="row justify-content-center">
                <div class="col-md-5 col-xl-7 col-xxl-8 g-0 order-md-0"><img class="img-fluid w-100 fit-cover h-100 rounded-top rounded-md-start rounded-md-top-0" src="{{ Storage::disk('public')->url($productOne->image) }}"  onerror="this.src='{{ asset('assets/img/noimage.jpg') }}'"alt="..."></div>
                <div class="col-md-7 col-xl-5 col-xxl-4 p-4 p-lg-5">
                  ...
                  <p class="fs-1">{!! $productOne->description  !!}</p>
